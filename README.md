...
``` bash
# dev server with hot reload at http://18.209.91.97:2023
$ npm start 
```
...
Navigate to [http://18.209.91.97:2023](http://18.209.91.97:2023). The app will automatically reload if you change any of the source files.
