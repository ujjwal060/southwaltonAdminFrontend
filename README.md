...
``` bash
# dev server with hot reload at http://98.85.246.54:2023
$ npm start 
```
...
Navigate to [http://98.85.246.54:2023](http://98.85.246.54:2023). The app will automatically reload if you change any of the source files.
